...
/// This is a helper for a numeric keypad.  It has the digits 0-9 and two miscellaneous buttons.  The Misc1SigName and Misc2SigName can be set to whatever the user wants, but default to "Misc_1" and "Misc_2".
/// </summary>
