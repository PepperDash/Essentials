...
namespace PepperDash.Essentials.Core
{
  ...
  /// </summary>
        ...
        public static bool IsRunningMinimumVersionOrHigher(string minimumVersion)
        {
            ...
            var runtimeVersionMajor = short.Parse(runtimeVersion.Groups[1].Value);
            var runtimeVersionMinor = short.Parse(runtimeVersion.Groups[2].Value);
            var runtimeVersionBuild = short.Parse(runtimeVersion.Groups[3].Value);
