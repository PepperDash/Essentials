...
public class PasswordPromptEventArgs : EventArgs
{
    ...
    /// <param name="loginFailed">Indicates that the login attempt has failed</param>
    /// <param name="loginCancelled">Indicates that the process was cancelled and the prompt should be dismissed</param>
