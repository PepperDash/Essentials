...
{
    public abstract class EssentialsFusionSystemControllerBase : EssentialsDevice, IOccupancyStatusProvider
    {
        ...
        protected EssentialsFusionSystemControllerBase(EssentialsRoomBase room, uint ipId)
            : base(room.Key + "-fusion")
        {
            try
            {
                ...
                GuidFilePath = Global.FilePathPrefix +
        ...
        protected void CreateSymbolAndBasicSigs(uint ipId)
        {
            ...
            if (FusionRoom != null)
            {
                Debug.Console(0, this, Debug.ErrorLogLevel.Notice, "Fusion Room symbol with GUID {0} already created",
                    RoomGuid);
                return;
            }
        ...
        protected virtual void SetUpDisplay()
        {
            try
            {
                SetUpDisplayUsageTracking();

                SetUpDefaultDisplay();

                SetUpDefaultDisplayAsset();
        ...
        protected virtual void SetUpDisplayUsageTracking()
        {
        ...
        protected virtual void SetUpDefaultDisplay()
        {
        ...
        protected virtual void SetUpDefaultDisplayAsset()
        {
